...
import com.example.confetti.confetto.Confetto;
...
public class ConfettiManager {
    ...
    private float initialScaleDeviation=0f;
     ...
     * @return the confetti manager so that the set calls can be chained.
     * @see #setInitialScale(float, float)
     */
    public ConfettiManager setInitialScale(float initialScale) {
        return setInitialScale(initialScale, 0);
    }

    /**
     * Set the initialScale used by this manager. This value defines the initial scale in
     *  for the generated confetti. The actual confetti's initial scale will be
     * (initialScale +- [0, initialRotationDeviation]).
     *
     * @param initialScale          the initial rotation in degrees.
     * @param initialScaleDeviation the deviation from initial rotation in degrees.
     * @return the confetti manager so that the set calls can be chained.
     */
    ...
    /**
     * @param scaleVelocity the initial Scale velocity per second.
     * @return the confetti manager so that the set calls can be chained.
     * @see #setScaleVelocity(float, float)
     */
    public ConfettiManager setScaleVelocity(float scaleVelocity) {
        return setScaleVelocity(scaleVelocity, 0f);
    }
     ...
     * rotational velocity will be (rotationalVelocity +- [0, rotationalVelocityDeviation]).
     *
     * @param scaleVelocity          the initial rotational velocity in degrees per second.
     * @param scaleVelocityDeviation the deviation from initial rotational velocity in
     *                                    degrees per second.
     * @return the confetti manager so that the set calls can be chained.
     */
    public ConfettiManager setScaleVelocity(float scaleVelocity,
        ...
        this.scaleAccelerationDeviation = scaleVelocityDeviation / 1000f;
        return this;
    }

    /**
     * @param scaleAcceleration the rotational acceleration in degrees per second^2.
     * @return the confetti manager so that the set calls can be chained.
     * @see #setScaleAcceleration(float, float)
     */
    public ConfettiManager setScaleAcceleration(float scaleAcceleration) {
        return setRotationalAcceleration(scaleAcceleration, 0f);
    }
     ...
     *
     * @param scaleAcceleration          the rotational acceleration in degrees per second^2.
     * @param scaleAccelerationDeviation the deviation from rotational acceleration in degrees
     *                                        per second^2.
     * @return the confetti manager so that the set calls can be chained.
     */
    public ConfettiManager setScaleAcceleration(float scaleAcceleration,
    ...
    /**
     * @param targetScaleVelocity the target rotational velocity in degrees per second.
     * @return the confetti manager so that the set calls can be chained.
     * @see #setTargetScaleVelocity(float, float)
     */
    public ConfettiManager setTargetScaleVelocity(float targetScaleVelocity) {
        return setTargetRotationalVelocity(targetScaleVelocity, 0f);
    }
     ...
     *
     * @param targetScaleVelocity          the target rotational velocity in degrees per second.
     * @param targetScaleVelocityDeviation the deviation from target rotational velocity
     *                                          in degrees per second.
     * @return the confetti manager so that the set calls can be chained.
     */
    public ConfettiManager setTargetScaleVelocity(float targetScaleVelocity,
                                                       float targetScaleVelocityDeviation) {
        this.targetScaleVelocity = targetScaleVelocity / 1000f;
    ...
    public ConfettiView getConfettiView() {
        return confettiView;
    }

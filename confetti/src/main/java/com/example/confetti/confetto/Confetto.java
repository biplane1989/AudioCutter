...
public abstract class Confetto {
    ...
    // Current draw states
    private float currentX, currentY, currentRotation, currentScale;
    protected float currentVelocityX, currentVelocityY, currentRotationalVelocity, currentScaleVelocity;
    // alpha is [0, 255]
    private int alpha;
    ...
    public void prepare(Rect bound) {
        ...
        millisToReachTargetScaleVelocity = computeMillisToReachTarget(targetScaleVelocity, initialScaleVelocity, scaleAcceleration);
    ...
    public boolean applyUpdate(long passedTime) {
        ...
        if (startedAnimation && !terminated) {
            ...
            computeDistance(workPairs, animatedTime, initialScale, initialScaleVelocity, scaleAcceleration, millisToReachTargetScaleVelocity, targetScaleVelocity);
            currentScale = workPairs[0];
            currentScaleVelocity = workPairs[1];
    ...
    private void draw(Canvas canvas, float x, float y, float rotation, float percentageAnimated) {
        ...
        drawInternal(canvas, matrix, workPaint, x, y, rotation, currentScale, percentageAnimated);
    ...
    protected abstract void drawInternal(Canvas canvas, Matrix matrix, Paint paint, float x,
                                         float y, float rotation, float scale, float percentAnimated);
    ...
    public void setInitialScaleVelocity(float initialScaleVelocity) {
        this.initialScaleVelocity = initialScaleVelocity;
    }
    ...
    public void setTargetScaleVelocity(Float targetScaleVelocity) {
        this.targetScaleVelocity = targetScaleVelocity;
    }

...
public class MaterialSpinner extends androidx.appcompat.widget.AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            textColor = ta.getColor(R.styleable.MaterialSpinner_ms_text_color, resources.getColor(R.color.dialog_advanced_text_sniper_color));
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            setBackgroundDrawable(getResources().getDrawable(R.drawable.border_spinner_bg));

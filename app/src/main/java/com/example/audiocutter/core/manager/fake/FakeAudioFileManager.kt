...
//        listCut.add(AudioFile(file4, "aloha", 10000, 128, uri = Uri.parse(file4.absolutePath), time = getTime(file4).toLong()))
...
//        listMix.add(AudioFile(file4, "aloha", 10000, 128, uri = Uri.parse(file4.absolutePath), time = getTime(file4).toLong()))
...
//        listMer.add(AudioFile(file4, "aloha", 10000, 128, uri = Uri.parse(file4.absolutePath), time = getTime(file4).toLong()))

...
class PhoneCallPerMissionDialog(val onAcceptListener: () -> Unit) : BaseDialog(),
    ...
    companion object {
        fun newInstance(onAcceptListener: () -> Unit): PhoneCallPerMissionDialog {
            return PhoneCallPerMissionDialog(onAcceptListener)
        }
    }

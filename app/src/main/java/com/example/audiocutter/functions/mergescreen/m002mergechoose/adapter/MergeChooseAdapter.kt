package com.example.audiocutter.functions.mergescreen.m002mergechoose.adapter
...
import com.example.audiocutter.functions.mergescreen.event.OnItemTouchHelper
import com.example.audiocutter.functions.mergescreen.m001merge.adapter.MergerDiff

class MergeChooseAdapter(val mContext: Context) :
    ListAdapter<AudioCutterView, MergeChooseAdapter.MergeChooseHolder>(
        MergerDiff()
    ), OnItemTouchHelper {
